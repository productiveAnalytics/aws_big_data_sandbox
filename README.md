...
2. [Multi-AZ (Failover) and Read Replica (performance) for Aurora RDS. Also promote RR and point using Route 53 CNAME](https://github.com/productiveAnalytics/aws_big_data_sandbox/blob/main/Aurora_RDS_promote_Read_Replica.md)
